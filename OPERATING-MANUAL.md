...
5. DISPLACED WORK GOES TO THE SOONEST REALISTIC SLOT — never the next scheduled
   day of that type. Follow-ups especially: we don't wait days to follow up.
6. Only a button press creates an event from a proposal. The board's buttons are
...
4. THINGS ALREADY SETTLED — never raise again:
   ...
   - Cal Callahan is booked for Fri 28 Aug. Stop treating him as an open thread.
